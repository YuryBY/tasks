function validateFormSave() {
	var newsTitle = document.getElementById("titleText");
	var newsDate = document.getElementById("dateText");
	var newsBrief = document.getElementById("briefArea");
	var newsContent = document.getElementById("contentArea");
